...
exports.insert = async (req, res, next) => {
    ...
    const { c_name, c_lastname, c_tel, c_email, c_num, c_mu, c_tanon, c_soi, 
    c_tumbon, c_amphor, c_jungwan, c_sex } = req.body;

    const check = await model.customers.create({
      c_name, c_lastname, c_tel, c_email, c_num, c_mu, c_tanon, c_soi, 
      c_tumbon, c_amphor, c_jungwan, c_sex 
    })
